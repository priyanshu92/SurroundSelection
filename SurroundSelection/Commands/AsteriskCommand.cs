...
namespace SurroundSelection.Commands
{
    ...
    internal sealed class AsteriskCommand
    {
        ...
        private AsteriskCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new AsteriskCommand(package, commandService);
        }
        ...
        private async void MenuItemCallbackAsync(object sender, EventArgs e)
        {
            ...
            if (dte != null && dte.ActiveDocument != null)
            {
                ...
                {
                    string message = "Please select some text to toggle asterisk";
