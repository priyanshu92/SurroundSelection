//------------------------------------------------------------------------------
// <copyright file="SquareBracketsCommand.cs" company="Company">
...
namespace SurroundSelection
{
    ...
    internal sealed class SquareBracketsCommand
    {
        ...
        private SquareBracketsCommand(Package package)
        {
            if (package == null)
            {
        ...
        {
            Instance = new SquareBracketsCommand(package);
        }
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            if (dte.ActiveDocument != null)
            {
                ...
                {
                    string message = string.Format(CultureInfo.CurrentCulture, "Please select some text to toggle square brackets", GetType().FullName);
