...
namespace SurroundSelection.Commands
{
    ...
    internal sealed class AngularBracketsCommand
    {
        ...
        private AngularBracketsCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new AngularBracketsCommand(package, commandService);
        }
        ...
        private async void MenuItemCallbackAsync(object sender, EventArgs e)
        {
            ...
            if (dte != null && dte.ActiveDocument != null)
            {
                ...
                {
                    string message = "Please select some text to toggle angular brackets";
