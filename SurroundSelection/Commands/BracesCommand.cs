...
namespace SurroundSelection.Commands
{
    ...
    internal sealed class BracesCommand
    {
        ...
        private BracesCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new BracesCommand(package, commandService);
        }
        ...
        private async void MenuItemCallbackAsync(object sender, EventArgs e)
        {
            ...
            if (dte != null && dte.ActiveDocument != null)
            {
                ...
                {
                    string message = "Please select some text to toggle braces";
